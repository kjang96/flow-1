...
class RoundaboutGenerator(Generator):
    ...
    def specify_routes(self, net_params):
        ...
        routes.add("inflow_1_0", ["inflow_1", "merge_in_1", "right", "top", "left", "merge_out_1", "outflow_1"], prob=0.2)
        routes.add("inflow_1_1", ["inflow_1", "merge_in_1", "right", "merge_out_0", "outflow_0"], prob=0.8) # ignore
        routes.add("inflow_0_0", ["inflow_0", "merge_in_0", "left", "merge_out_1", "outflow_1"], prob=0.2)
        routes.add("inflow_0_1", ["inflow_0", "merge_in_0", "left", "bottom", "right", "merge_out_0", "outflow_0"], prob=0.8) # ignore 
