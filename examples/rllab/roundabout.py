...
BATCH_SIZE = 20000
ITR = 600
exp_tag = "complex_25"  # experiment prefix
...
def run_task(*_):
    ...
    inflow = InFlows()
    inflow.add(veh_type="rl", edge="inflow_0", name="rl", vehs_per_hour=50, departLane="0")
    inflow.add(veh_type="rl", edge="inflow_0", name="rl", vehs_per_hour=50, departLane="1")
    inflow.add(veh_type="idm", edge="inflow_0", name="idm", vehs_per_hour=50, departLane="0")
    inflow.add(veh_type="idm", edge="inflow_0", name="idm", vehs_per_hour=50, departLane="0")
    inflow.add(veh_type="idm", edge="inflow_0", name="idm", vehs_per_hour=50, departLane="0")
    
    inflow.add(veh_type="rl", edge="inflow_1", name="rl", vehs_per_hour=50, departLane="0")
    inflow.add(veh_type="rl", edge="inflow_1", name="rl", vehs_per_hour=50, departLane="1")
    inflow.add(veh_type="idm", edge="inflow_1", name="idm", vehs_per_hour=50, departLane="0")
    inflow.add(veh_type="idm", edge="inflow_1", name="idm", vehs_per_hour=50, departLane="0")
    inflow.add(veh_type="idm", edge="inflow_1", name="idm", vehs_per_hour=50, departLane="0")
    inflow.add(veh_type="idm", edge="inflow_1", name="idm", vehs_per_hour=50, departLane="0")
    inflow.add(veh_type="idm", edge="inflow_1", name="idm", vehs_per_hour=50, departLane="0")
